          ...
          "1": {
            ...
            "metadata": {
              "inputs": [
                {
                  "name": "ComponentId",
                  "value": "/subscriptions/${data.azurerm_subscription.current.subscription_id}/resourcegroups/${appgw_rg}/providers/microsoft.operationalinsights/workspaces/${appgw_law_workspace}",
                  "isOptional": true
                },
                {
                  "name": "Dimensions",
          ...
          "2": {
            ...
            "metadata": {
              "inputs": [
                {
                  "name": "ComponentId",
                  "value": "/subscriptions/${data.azurerm_subscription.current.subscription_id}/resourceGroups/${hw_reportal_rg}/providers/Microsoft.Insights/components/${reportal_ai}"
                }
              ],
                  ...
                  "value": {
                    "chart": {
                      "metrics": [
                        {
                          "resourceMetadata": {
                            "id": "/subscriptions/${data.azurerm_subscription.current.subscription_id}/resourceGroups/${hw_reportal_rg}/providers/Microsoft.Sql/servers/${sql_server_name}/databases/${sql_db_name}"
                          },
                          "name": "cpu_percent",
                          "aggregationType": 3,
                          "metricVisualization": {
